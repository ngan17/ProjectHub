...
<div class="container-fluid">
    ...
    <!-- Group Header -->
    <div class="card border-0 shadow-sm mb-4 text-white" style="background: linear-gradient(135deg, #2563eb 0%, #1d4ed8 100%);">
        ...
        <div class="col-lg-4">
            ...
            @if(Auth::id() != $group->leader_id && $members->contains('user_id', Auth::id()))
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form method="POST" action="#" onsubmit="return confirm('Bạn có chắc muốn rời khỏi nhóm này?');">
                            @csrf
                            @method('DELETE')
